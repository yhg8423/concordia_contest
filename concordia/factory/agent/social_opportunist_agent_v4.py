  ...
  people_representation = (
      agent_components.person_representation.PersonRepresentation(
          ...
          additional_questions=(
              ('Given recent events, is the aforementioned character considered social '
               'responsible and cooperative? Evaluate their behavior on a scale of 0 to 10.'
               'Please answer in the format `{agent_name} thinks ...` For example,'
               '`{agent_name} thinks [other person]\'s social responsibility is 4, because ...`, `{agent_name} thinks [other person]\'s social responsibility is 7, because ...`'),
          ),
