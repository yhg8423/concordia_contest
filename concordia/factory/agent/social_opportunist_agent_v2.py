  ...
  def __init__(self, **kwargs):
    super().__init__(
        question=(
            ...
            "of social value and personal benefit. Consider the following factors:\n"
            "1. Context and scope of the situation\n"
            "2. Short-term and long-term consequences\n"
            "3. Ethical aspects\n"
            "4. Potential impact on society and the individual\n\n"
            "After your assessment, please respond in the following format:\n"
            "Social Value Importance: [Score between 0-10]\n"
            "Personal Benefit Importance: [Score between 0-10]\n"
            "Analysis: [Provide a brief explanation]\n"
            "\nHigher scores indicate greater importance of that aspect."
        ),
        answer_prefix="Situation Assessment Result:\n",
        add_to_memory=True,
...
def build_agent(
  ...
  situation_assessment_label = (
      ...
      f'of social value and personal benefit. Consider the following factors:\n'
      f'1. Context and scope of the situation\n'
      f'2. Short-term and long-term consequences\n'
      f'3. Ethical aspects\n'
      f'4. Potential impact on society and the individual\n\n'
      f'After your assessment, please respond in the following format:\n'
      f'Social Value Importance: [Score between 0-10]\n'
      f'Personal Benefit Importance: [Score between 0-10]\n'
      f'Analysis: [Provide a brief explanation]\n'
      f'\nHigher scores indicate greater importance of that aspect.\nAnswer'
  )
