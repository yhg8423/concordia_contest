...
# class RiskEvaluation(agent_components.question_of_recent_memories.QuestionOfRecentMemories):
#   """This component evaluates the risk of each option for the agent."""

#   def __init__(self, **kwargs):
#     super().__init__(
#         question=(
#             "For each option {agent_name} is considering, evaluate the risk "
#             "that {agent_name} would incur if they chose that option on a "
#             "scale of 0 to 10. Provide a score and a brief explanation for "
#             "each option. Please answer in the format `{agent_name} thinks that the risk of option X is Y, because ..., and the risk of option Z is W, because ...` "
#             "For example, `{agent_name} thinks that the risk of option X is 4, because ..., and the risk of option Z is 7, because ...`"
#         ),
#         answer_prefix="{agent_name} thinks that ",
#         add_to_memory=False,
#         memory_tag='[risk evaluation]',
#         **kwargs,
#     )
...
def build_agent(
  ...
  risk_aversion = agent_components.constant.Constant(
    state=(f'{agent_name} exhibits strong risk aversion tendencies. {agent_name} is '
           ...
           f'even if they promise higher returns.\n\n'
           ...
           f'to gather more information or delay decisions.\n\n'
           ...
           f'aggressive ones, sometimes appearing overly cautious.\n\n'
           ...
           f'driver is an instinctive avoidance of risk.\n\n'
