...
def build_agent(
  ...
  optimal_option_selection_label = (
      f'\nQuestion: Based on the social value and personal benefit evaluations, '
      f'which option has the highest total score for {agent_name}? '
      f'Calculate the sum of social value and personal benefit scores for each option, '
  ...
  optimal_option_selection = (
      agent_components.question_of_recent_memories.QuestionOfRecentMemories(
          ...
          question=(
              f"Based on the social value and personal benefit evaluations, "
              f"which option has the highest total score for {agent_name}? "
              f"Calculate the sum of social value and personal benefit scores for each option, "
              f"and select the option with the highest total. Provide a brief explanation "
              f"of your calculation and selection."
