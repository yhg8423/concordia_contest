  ...
  def __init__(self, **kwargs):
    super().__init__(
        question=(
            ...
            "each option. Please answer in the format `{agent_name} thinks that the loss of option X is Y, because ..., and the loss of option Z is W, because ...` "
            "For example, `{agent_name} thinks that the loss of option X is 4, because ..., and the loss of option Z is 7, because ...`"
        ),
